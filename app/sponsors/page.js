...
></div>
      ...
      <Link href="#footer">
        <button className="relative px-8 py-3 w-52 h-14 text-white font-Orbitron text-lg  rounded-full transition-transform duration-300 ease-in-out border-2  bg-transparent border-green-400 flex justify-center items-center hover:scale-105 hover:shadow-[0_0_15px_rgba(34,197,94,0.7)]">
          Sponsorship
        </button>
      </Link>
    </div>
